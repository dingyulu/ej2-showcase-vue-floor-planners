<template>
  <div>
        ...
        <div class="db-toolbar-editor">
          <div class="db-toolbar-container">
            <ejs-toolbar
              ...
              v-on:clicked="toolbarEditorClick($event)"
            >
              <e-items>
                <e-item
                ...
                <e-item
                  prefixIcon="sf-icon-pan"
                  tooltipText="Pan Tool"
                  cssClass="tb-item-start pan-item"
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-pointer"
                  tooltipText="Select Tool"
                  cssClass="tb-item-middle tb-item-selected"
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-straight_line"
                  tooltipText="Straight"
                  cssClass="tb-item-middle"
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-text"
                  tooltipText="Text Tool"
                  cssClass="tb-item-end"
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-group"
                  tooltipText="Group"
                  :visible="false"
                  align="Center"
                  cssClass="tb-item-start tb-item-align-category"
                ></e-item>
                <e-item type="Separator" :visible="false" align="Center">
                </e-item>
                <e-item
                  prefixIcon="sf-icon-align_left"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-align_center"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-align_right"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-align_middle"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-align_bottom"
                  :visible="false"
                  align="Center"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-distribute_horizontal"
                  :visible="false"
                  align="Center"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-distribute_vertical"
                  :visible="false"
                  align="Center"
                ...
                <e-item
                  prefixIcon="sf-icon-bring-forward"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-bring-to-front"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-send-backward"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-send-to-back"
                ...
                <e-item
                  prefixIcon="sf-icon-flip-vertical"
                ...
                ></e-item>
                <e-item
                  prefixIcon="sf-icon-flip-horizontal"
          ...
          <div class="db-diagram-container">
            <div id="diagramContainerDiv" class="db-current-diagram-container">
              <ejs-diagram
                ...
                :selectionChange="
                  this.diagramEvents.selectionChange.bind(this.diagramEvents)
                "
                :positionChange="
                  this.diagramEvents.nodePositionChange.bind(this.diagramEvents)
                "
                :sizeChange="
                  this.diagramEvents.nodeSizeChange.bind(this.diagramEvents)
                "
                :rotateChange="
                  this.diagramEvents.nodeRotationChange.bind(this.diagramEvents)
                "
                :dragEnter="
                  this.diagramEvents.dragEnter.bind(this.diagramEvents)
                "
                :historyChange="
                  this.diagramEvents.historyChange.bind(this.diagramEvents)
                "
                :scrollChange="this.scrollChange.bind(this)"
                :collectionChange="
                  this.diagramEvents.collectionChange.bind(this.diagramEvents)
                "
              ></ejs-diagram>
            </div>
          </div>
            ...
            >
              ...
              >
                <div class="row db-prop-header-text">
                  ...
                  <ejs-button
                    class="close"
                    v-on:click.native="hideElements('hide-properties', diagram)"
                    ><i
                  ...
                  <div class="row db-prop-row">
                    ...
                    >
                      <ejs-button
                        ...
                        id="aspectRatioBtn"
                        v-on:click.native="aspectClick($event)"
                  ...
                  <div class="row db-prop-row">
                    <div class="col-xs-6 db-col-left">
                      <ejs-button
                        ...
                        cssClass="e-outline"
                        isPrimary="true"
                        v-on:click.native="toolbarInsertClick($event)"
                ...
                <div id="nodeStyleProperties" class="db-node-style-prop">
                  ...
                  <div class="row db-border-style">
                    ...
                    <div class="row">
                      <div
                        class="col-xs-6 db-col-right"
                        style="width: 77px; margin-right: 0px"
                      >
                        <ejs-dropdownlist
                          id="nodeBorderStyle"
                      ...
                      <div
                        class="col-xs-2 db-col-right"
                        style="width: 73px; margin-left: 32px"
                      >
                        <div class="db-text-container">
                          <div class="db-text-input">
                            <ejs-numerictextbox
                    ...
                    <div class="row db-prop-row">
                      <div
                        ...
                        style="margin-right: 5px; padding-top: 6px"
                      >
              ...
              >
                ...
                <div class="row db-prop-row">
                  <div
                    class="col-xs-2 db-col-right db-prop-text-style"
                    style="margin-right: 3px; padding-top: 6px"
                  >
                    <span class="db-prop-text-style">Opacity</span>
                  </div>
                  <div
                    class="col-xs-8 db-col-left"
                    style="width: 120px; padding-right: 10px; margin-left: 10px"
                  >
                    <ejs-slider
                      id="default"
                      min="0"
              ...
              >
                ...
                <div class="row db-prop-row">
                  ...
                  >
                    <ejs-dropdownlist
                      ...
                      "
                      :value="selectedItem.textProperties.textPosition"
                      :fields="dropdownListFields"
                      v-on:change="
                  ...
                  <div class="col-xs-6 db-col-right">
                    <div>
                      <ejs-toolbar
                        ...
                        overflowMode="Scrollable"
                        v-on:clicked="
                          diagramPropertyBinding.toolbarTextSubAlignChange(
                            $event
                          )
                        "
                      >
                ...
                <div class="row db-prop-row">
                  <div
                    class="col-xs-2 db-col-right db-prop-text-style"
                    style="margin-right: 12px; padding-top: 6px"
                  >
                    <span class="db-prop-text-style">Opacity</span>
                  </div>
                  <div
                    class="col-xs-8 db-col-left"
                    style="width: 130px; padding-right: 10px; margin-left: 5px"
                  >
                    <ejs-slider
    ...
    >
      <div id="printDialogContent">
        ...
        >
          <div class="col-xs-3 db-prop-col-style" style="margin-right: 8px">
            <ejs-radiobutton
              ...
              label="Portrait"
              name="printSettings"
              :checked="selectedItem.printSettings.isPortrait"
            >
            </ejs-radiobutton>
          </div>
          <div class="col-xs-3 db-prop-col-style">
            <ejs-radiobutton
              ...
              label="Landscape"
              name="printSettings"
              :checked="selectedItem.printSettings.isLandscape"
            >
            </ejs-radiobutton>
          </div>
        </div>
        <div class="row db-dialog-prop-row" style="margin-top: 16px">
          <ejs-checkbox
            id="printMultiplePage"
            label="Scale to fit 1 page"
            :checked="selectedItem.printSettings.multiplePage"
          ></ejs-checkbox>
        </div>
      </div>
    </ejs-dialog>
    ...
    <!-- <el-dialog title="展位属性" :visible.sync="dialogFormVisible">
      <el-form :model="form">
...
import {
  MultiSelectPlugin,
  DropDownTreeComponent as EjsDropdowntree,
  DdtSelectEventArgs,
} from "@syncfusion/ej2-vue-dropdowns";
...
export default class User extends Vue {
  ...
  public diagramPropertyBinding: DiagramPropertyBinding =
    new DiagramPropertyBinding(this.selectedItem);
  ...
  public scrollChange(args: IScrollChangeEventArgs): void {
    var btnZoomIncrement = (document.getElementById("btnZoomIncrement") as any)
      .ej2_instances[0];
    if (args.panState !== "Start") {
      btnZoomIncrement.content =
        Math.round((this.diagram as any).scrollSettings.currentZoom * 100) +
        " %";
    }
  ...
  public diagramNameChange(args: MouseEvent): void {
    ...
    document
      .getElementsByClassName("db-diagram-name-container")[0]
      .classList.remove("db-edit-name");
    (document.getElementById("exportfileName") as any).value = (
      document.getElementById("diagramName") as any
    ).innerHTML;
    console.log(
      "!!@@",
      (document.getElementById("diagramName") as any).innerHTML
  ...
  public enableMenuItems(itemText: string) {
    let selectedDiagram = (this.diagram as any).ej2_instances
      ? (this.diagram as any).ej2_instances[0]
      : (this.diagram as any);
    ...
    if (itemText) {
      ...
      if (
        !(
          (this.diagram as any).commandHandler.clipboardData.pasteIndex !==
            undefined &&
          (this.diagram as any).commandHandler.clipboardData.clipObject !==
            undefined
        ) &&
        itemText === "Paste"
      ) {
      ...
      if (
        itemText === "Undo" &&
        (this.diagram as any).historyManager.undoStack.length === 0
      ) {
        return true;
      }
      if (
        itemText === "Redo" &&
        (this.diagram as any).historyManager.redoStack.length === 0
      ) {
        return true;
      }
  ...
  public aspectClick() {
    var isAspect = true;
    let aspectRatioBtn = (document.getElementById("aspectRatioBtn") as any)
      .ej2_instances[0];
    if (
      (document.getElementById("aspectRatioBtn") as any).classList.contains(
        "e-active"
      )
    ) {
      (document.getElementById("aspectRatioBtn") as any).classList.remove(
        "e-active"
      );
      isAspect = false;
  ...
  public menuClick(args: MenuEventArgs): void {
    ...
    let diagram: Diagram;
    let command: any = (args.item as any).text
      .replace(/[" "]/g, "")
      .toLowerCase();
    switch (command) {
      case "new":
      ...
      case "fittowidth":
        ...
        break;
      case "showrulers":
        (this.diagram as any).rulerSettings.showRulers = !(this.diagram as any)
      ...
      case "landscape":
        ...
        (document.getElementById("pageLandscape") as any).classList.add(
          "e-active"
        );
        (document.getElementById("pagePortrait") as any).classList.remove(
          "e-active"
        );
        break;
      case "portrait":
        ...
        (document.getElementById("pagePortrait") as any).classList.add(
          "e-active"
        );
        (document.getElementById("pageLandscape") as any).classList.remove(
          "e-active"
        );
        break;
  ...
  //保存展位图JSON到表单
  public floorPlan() {
    if (!this.boothChartId || !this.name || !this.contents) {
      this.$message.error("请绑定展位图表单配置!");
      return;
    }
    console.log(typeof this.diagram.saveDiagram());
    console.log("^^^^-----^^^^");
    const token = this.tokenValue;
    //const JsonString = JSON.stringify(this.diagram.saveDiagram());
    const url =
      "https://work.baizhanke.com/api/visualdev/OnlineDev/" +
      this.boothChartId +
      "/0";
    const data: any = {
      // data:{"comInputField102":JsonString},
      data: JSON.stringify({
        [this.name]: (document.getElementById("diagramName") as any).innerHTML,
        [this.contents]: this.diagram.saveDiagram(),
      }),
      id: "",
      isDraft: false,
    };
  ...
  public toolbarEditorClick(args: ClickEventArgs): void {
    let diagram: Diagram = (document.getElementById("diagram") as any)
      .ej2_instances[0];
    let commandType: string = (args.item.tooltipText as any)
      .replace(/[' ']/g, "")
      .toLowerCase();
    switch (commandType) {
      case "new":
      ...
      case "save":
        ...
        break;
      case "fillcolor":
        var objColor = (this.diagram as any).selectedItems.nodes[0]
          ? "nodeFillColor"
          : "lineColor";
  ...
  public flipObjects(flipType: string, diagram: Diagram) {
    var selectedObjects = (diagram as any).selectedItems.nodes.concat(
  ...
  public loadDiagram(event: ProgressEvent): void {
    (this.diagram as any).loadDiagram(
      (event.target as FileReader as any).result.toString()
    );
  }
  public setImage(event: ProgressEvent): void {
    let node: NodeModel = (this.selectedItem.diagram as any).selectedItems
      .nodes[0];
    node.shape = {
      type: "Image",
  ...
  public toolbarInsertClick(args: ClickEventArgs): void {
    ...
    let commandType = (args.item ? args.item.text : (args as any).target.id)
      .replace(/[' ']/g, "")
      .toLowerCase();
        ...
        case "insertlink":
          ...
          if (diagram.selectedItems.nodes[0].annotations.length > 0) {
            let annotation: ShapeAnnotationModel =
              diagram.selectedItems.nodes[0].annotations[0];
            if ((annotation.hyperlink as any).link || annotation.content) {
              (
                document.getElementById("hyperlink") as HTMLInputElement as any
              ).value = (annotation.hyperlink as any).link;
              (
                document.getElementById(
                  "hyperlinkText"
                ) as HTMLInputElement as any
              ).value =
                (annotation.hyperlink as any).content || annotation.content;
            }
          }
  ...
  private btnUploadNext(args: MouseEvent): void {
    ...
    const uploadDialogContent: any = document.getElementById(
      "uploadDialogContent"
    );
    if (OrgChartUtilityMethods.isUploadSuccess) {
      if (uploadDialogContent.className === "db-upload-content firstPage") {
        if (OrgChartUtilityMethods.fileType === "xml") {
          (this.fileUploadDialog as any).header =
  ...
  private btnHyperLink(): void {
    let node: Node = (this.selectedItem as any).diagram.selectedItems
      .nodes[0] as Node;
    if (node.annotations.length > 0) {
      (node.annotations[0].hyperlink as any).link = (
        document.getElementById("hyperlink") as HTMLInputElement
      ).value;
      (node.annotations[0].hyperlink as any).content = (
  ...
  private applyToolTipforHyperlink(node: Node): void {
    ...
    node.tooltip = {
      content: (node.annotations[0].hyperlink as any).link,
      relativeMode: "Object",
      position: "TopCenter",
      showTipPointer: true,
    };
  ...
  private lockObject(): void {
    ...
    for (
      let i: number = 0;
      i < (diagram.selectedItems.nodes as any).length;
      i++
    ) {
    ...
    for (
      let i: number = 0;
      i < (diagram.selectedItems.connectors as any).length;
      i++
    ) {
  ...
  public hideElements(): void {
    var diagramContainer = document.getElementsByClassName(
    ...
    if (diagramContainer.classList.contains("hide-properties")) {
      ...
      (
        document.getElementById("hideProperty") as HTMLButtonElement
      ).style.backgroundColor = "";
      (
        document.getElementById("hideProperty") as any
      ).ej2_instances[0].isPrimary = true;
    } else {
      diagramContainer.classList.add("hide-properties");
      (document.getElementById("hideProperty") as any).style.backgroundColor =
        "#e3e3e3";
      (
        document.getElementById("hideProperty") as any
  ...
  openDialog() {
    if (
      ...
      this.$message.error("请绑定展位表单配置!");
      return;
    }
    this.dialogVisible = true;
    this.fetchData(); // 打开弹出框时获取数据
  }
  ...
  private fetchData() {
    ...
    const token = this.tokenValue;
    const url =
      "https://work.baizhanke.com/api/visualdev/OnlineDev/InnerApi/" +
      this.boothId +
      "/List";
    const data: any = {
      currentPage: 1,
      ...
      searchType: "1",
      viewId: "0",
      isQueryAllViewData: true,
      condition: { conjunction: "AND", conditions: [] },
      dataConvertFlag: 0,
    };
    axios
      .post(url, data, {
      ...
      .then((response) => {
        // 处理后端返回的响应
        this.dialogData = response.data.data.list;
    ...
    axios
      ...
      .then((response1) => {
        this.fields = JSON.parse(response1.data.data.formData).fields;
        //获取视图中详情页的详情字段
        this.tempView = JSON.parse(
          response1.data.data.columnData
        ).formViewColumns;
        console.log("4556577654:", this.tempView);
        for (let i = 0; i < this.tempView.length; i++) {
          if (
            this.tempView[i].column_type == "3" &&
            this.tempView[i].isShow == true
          ) {
            this.tempField.push(this.tempView[i]);
          }
        }

        // 处理后端返回的响应
        for (const key in this.fields) {
          // this.labels  = this.fields[key].config.label
          this.tableColumns.push({
            label: this.fields[key].config.label,
            prop: this.fields[key].vModel,
          });
        }
        console.log(this.fields);
        // console.log(this.fields)
        console.log("Data added successfully11111111111:", response1.data.data);
      })
      .catch((error) => {
        console.error("Error adding data:", error);
      });
  ...
  handleRowClick(row: any) {
    this.selectedRow = row; // 当点击行时，更新选中的行
  }

  confirmSelection() {
    this.BoothDataId = [];
    if (this.selectedRow) {
      this.BoothDataId.push({
        id: this.selectedRow[0].id,
      });
      console.log(this.BoothDataId);
      console.log("你确认选择了：", this.selectedRow);
    } else {
      console.log("没有选择任何行");
    }
    (this.selectedItem as any).nodeProperties.boothData = this.BoothDataId;
    console.log("^^^^^^^^^^^^", this.boothState);
    console.log("&&&&&&&&&&&&", this.selectedRow[0][this.boothState]);
    if (this.selectedRow[0][this.boothState] == "已锁定") {
      (this.selectedItem as any).nodeProperties.fillColor = "#e0ffff";
    }
    if (this.selectedRow[0][this.boothState] == "没锁定") {
      (this.selectedItem as any).nodeProperties.fillColor = "#1dc751";
    }
    this.annotation();
    console.log(this.selectedItem);
    (this.selectedItem as any).nodeProperties.tempData = {
      dialogdata: this.dialogData,
      fieldss: this.fields,
      selectedrow: this.selectedRow,
      tempfield: this.tempField,
    };

    console.log("{}", (this.selectedItem as any).nodeProperties.tempData);
  ...
  public annotation() {
    let node: Node = (this.selectedItem as any).diagram.selectedItems
      .nodes[0] as Node;
    (this.selectedItem.diagram as any).removeLabels(node, node.annotations);
    let boothNoAnnotation: ShapeAnnotationModel = {
      content: this.selectedRow[0][this.boothNo],
    ...
    let sizeAnnotation: ShapeAnnotationModel = {
      content: this.selectedRow[0][this.boothSize],
      constraints: AnnotationConstraints.ReadOnly,
      style: {
        fontSize: 7,
        textAlign: "Center",
    ...
    let widthAnnotation: ShapeAnnotationModel = {
      content: this.selectedRow[0][this.boothWidth],
      constraints: AnnotationConstraints.ReadOnly,
      style: {
        fontSize: 7,
        textAlign: "Center",
    ...
    let heightAnnotation: ShapeAnnotationModel = {
      content: this.selectedRow[0][this.boothHeight],
      constraints: AnnotationConstraints.ReadOnly,
      style: {
        fontSize: 7,
        textAlign: "Center",
    ...
    let bindEnterpriseAnnotation: ShapeAnnotationModel = {
      content: this.selectedRow[0][this.boothBindEnterprise],
      constraints: AnnotationConstraints.ReadOnly,
      style: {
        fontSize: 7,
        textAlign: "Center",
    ...
    (this.selectedItem.diagram as any).addLabels(node, [
      boothNoAnnotation,
      sizeAnnotation,
      widthAnnotation,
      heightAnnotation,
      bindEnterpriseAnnotation,
    ]);
    (this.selectedItem.diagram as any).dataBind();
  }
  //预览情况下点击节点弹出框内显示展位属性
  // dialogFormVisible = false;
  // public diagramClick1(args: IClickEventArgs): void {
  //   if(args && args.actualObject && args.element instanceof Node ){
  ...
  private fetchBoothChartList() {
    const token = this.tokenValue;
    const url = "https://work.baizhanke.com/api/visualdev/Base";
    axios
      .get(url, {
        headers: {
          "Content-Type": "application/json",
  ...
  private fetchBoothField(id) {
    ...
    axios
      ...
      .then((response) => {
        // 处理后端返回的响应
        let formData = JSON.parse(response.data.data.formData).fields;
        this.dropDownListBooth = [];
        for (const key in formData) {
          this.dropDownListBooth.push({
            label: formData[key].config.label,
            prop: formData[key].vModel,
            identity: key,
          });
        }
        this.dropDownfieldsBooth = { value: "prop", text: "label" };
        console.log("@@@", this.dropDownListBooth);
  ...
  dropDownList: any[] = [];
  dropDownfields = {};
  private fetchBoothCharContentsAndName(id) {
    const token = this.tokenValue;
    const url = "https://work.baizhanke.com/api/visualdev/Base/" + id;
    axios
      .get(url, {
